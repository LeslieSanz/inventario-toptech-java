 ...
 * @author esther
 */
public class FormSalida extends javax.swing.JFrame {
    DefaultTableModel modelo1 = new DefaultTableModel();
    DefaultTableModel modelo2 = new DefaultTableModel();
    public FormSalida() {
        initComponents();
        this.setLocationRelativeTo(this);
        this.setTitle("FormSalida");
        establecerColumnas1();
        establecerColumnas2();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormSalida().setVisible(true);
            }
        });
    }
